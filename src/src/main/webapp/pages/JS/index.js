...
function search() {
    $.ajax({
        url: "/library/api/findBookInstancesByPrompt",
        data: {
...
function selectBookInstance(isbn) {
    $.ajax({
        url: "/library/api/findBookInstanceByISBN",
        data: {
            isbn: isbn
        },
        type: "get",
...
function updateSelectedInstance(instance)
{
    ...
    if (instance.status === "Available") {
        ...
        `
            ...
            var returnButton = ""
            if (instance.borrower.name === username || isLibrarian) {
            ...
            <tr>
                <td>Borrower name</td>
                <td>${instance.borrower.name} ${returnButton} </td>
            </tr>
        `
    }
